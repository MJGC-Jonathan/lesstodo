...
$(document).ready(function() {
  ...
  $aboutButton.click(function() {
    if ($overlay == undefined) {
      $overlay = $('<div>').attr('id', 'overlay').html('<p>LessToDo was created by <a class="about-link" target="_blank" href="https://twitter.com/TrampolineTales">Dan DiIorio</a> as a solution to his own anxiety with planning out projects. Diagnosed with an <a class="about-link" target="_blank" href="https://en.wikipedia.org/wiki/Anxiety_disorder">anxiety disorder</a> at the age of 15, Dan always had trouble reading to-do lists without getting anxious and overwhelmed. LessToDo solves this issue by only displaying one ToDo at a time, even if the amount of work that actually needs to get done would feel overwhelming when looked at all at once. Dan has been using LessToDo to work on his own personal projects, and hopes you find success with it as well!</p><p>LessToDo is released under the <a class="about-link" target="_blank" href="https://github.com/TrampolineTales/lesstodo/blob/master/LICENSE">GNU AGPLv3 License</a></p><a id="close-button" href="#">Close</a>');
